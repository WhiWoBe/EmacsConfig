...
At the moment File structure and Drive Name is the Same under Work and Private PC 
...
to be added to the $PATH Variable. Additionally sending the informations about the
...
| CANCELED             | :foreground | grey      |             |         |       |   |         |      |      |                                        |
| HOLD                 | :foreground | yellow    |             |         |       |   |         |      |      |                                        |
| Initiation           | :background | #118ab2   | :foreground | bfc0c0  |       |   |         |      |      |                                        |
| Planning             | :background | #ffd166   | :foreground | black   |       |   |         |      |      |                                        |
| Execution&Monitoring | :background | #ef476f   | :foreground | #22333b | :bold | t | :weight | bold | :box | (:line-width 2 :style released-button) |
| Closing              | :background | #718355   | :foreground | black   |       |   |         |      |      |                                        |
| Done                 | :background | #06d6a0   | :foreground | black   |       |   |         |      |      |                                        |
| Canceled             | :background | grey      | :foreground | black   |       |   |         |      |      |                                        |
| Hold                 | :background | lightgrey | :foreground | black   |       |   |         |      |      |                                        |
...
#+RESULTS:
| d | Day | ((agenda  ((org-agenda-block-separator nil) (org-agenda-span 'day) (org-agenda-entry-types '(:deadline)) (org-agenda-prefix-format '((agenda .  %i %?-12t %-12s))) (org-deadline-warning-days 30) (org-agenda-overriding-header |
